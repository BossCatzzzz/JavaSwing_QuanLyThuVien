...
public class fdThemDG extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lbMaDG.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        rdbtNam.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        rdbtNam.setSelected(true);
        rdbtNam.setText("Nam");
        pnTTDG.add(rdbtNam, new org.netbeans.lib.awtextra.AbsoluteConstraints(387, 102, -1, -1));

        buttonGroup1.add(rdbtNu);
        rdbtNu.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        rdbtNu.setText("Nữ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(132, 132, 132)
                .addComponent(btThemDG, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 96, Short.MAX_VALUE)
                .addComponent(btHuyBo, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(132, 132, 132))
    ...
    private void btThemDGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemDGActionPerformed
        ...
        try {
            long sdt = Long.parseLong(tbSDTDG.getText());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Số điện thoại không đúng định dạng");
            return;
        }
        if (tbSDTDG.getText().length() > 10) {
            JOptionPane.showMessageDialog(this, "Số điện thoại tối đa 10 số");
            return;
        }
        try {
            long sdt = Long.parseLong(tbCMTDG.getText());
        } catch (Exception e) {
        ...
        if (btThemDG.getText().equals("Thêm")) {
            ...
            try {
                db.RunQuery(query);
                JOptionPane.showMessageDialog(this, "Đã thêm Độc giả!!\n");
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this, "Lỗi khi thêm mới Độc giả:\n" + ex.getMessage());
            }
            ...
            try {
                db.RunQuery(query);
                JOptionPane.showMessageDialog(this, "Đã lưu thay đổi thông tin Độc giả!!\n");
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this, "Lỗi khi sửa thông tin Độc giả:\n" + ex.getMessage());
            }
        }
